...
function conky_main_box()
    ...
    --FIRST COLUMN
        --default colour and corner
       	{x=0, y=0, w=320, h=700,
      	colour={{0,0x858585,1}, {1,0x000000,1}}, linear_gradient= {0,0,0,700},corners={ {"circle",20}} },

      	{x=10, y=30, w=140, h=140, 
      	colour={{0,0x858585,1}, {1,0x000000,1}}, linear_gradient= {140,140,10,10} ,
      	corners={ {"circle",70} }, },
      	{x=20, y=40, w=120, h=120,
      	colour={{0,0x858585,1}, {1,0x000000,1}}, linear_gradient= {20,20,120,120}  ,
      	corners={ {"circle",60} }, },
      	...
      	colour={{0,0x858585,1}, {1,0x000000,1}}, linear_gradient= {70,70,10,10} ,
      	corners={ {"circle",35} }, },
      	{x=240, y=365, w=60, h=60,
      	colour={{0,0x858585,1}, {1,0x000000,1}}, linear_gradient= {20,20,60,60}  ,
      	corners={ {"circle",30} }, },
